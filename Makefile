...
start:
	sudo docker run -d -p 8081:8080 -p 5555:5555 --cpuset-cpus="0-31" --cpuset-mems="0" --privileged --name servoc_container_1 servoc:latest && \
	sudo docker run -d -p 8082:8080 -p 5556:5555 --cpuset-cpus="32-63" --cpuset-mems="1" --privileged --name servoc_container_2 servoc:latest && \
